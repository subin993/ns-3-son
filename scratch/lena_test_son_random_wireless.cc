...
main (int argc, char *argv[])
{
  ...
  uint16_t numberOfUes = 120;
  uint16_t numberOfEnbs = 6;
  uint16_t numBearersPerUe = 6;
  ...
  xPos->SetAttribute ("Min", DoubleValue (125.0));
  xPos->SetAttribute ("Max", DoubleValue (275.0));
  allocator->SetX (xPos);
  Ptr<UniformRandomVariable> yPos = CreateObject<UniformRandomVariable> ();
  yPos->SetAttribute ("Min", DoubleValue (75.0));
  yPos->SetAttribute ("Max", DoubleValue (225.0));
  allocator->SetY (yPos);
  ...
  ueMobility.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (0, 400, 0, 300)),
      ...
      for (uint32_t b = 0; b < numBearersPerUe; ++b)
        {
          ...
          dlServerApps.Start (startTime);
          dlClientApps.Start (startTime);
          ulServerApps.Start (startTime);
          ulClientApps.Start (startTime);
        } // end for b
    }
