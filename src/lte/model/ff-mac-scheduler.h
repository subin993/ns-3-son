...
public:
  ...
  */
  ...
  double m_ulPRBUsage=0.0;
  double m_dlPRBUsage=0.0;
  ...
  virtual double getUlPRBUsage(); //NS-3 SON: this will be used on pf-ff mac sched
  virtual double getDlPRBUsage(); //NS-3 SON: this will be used on pf-ff mac sched

  virtual double resetUlPRBUsage (); //NS-3 SON: this will be used on pf-ff mac sched
  virtual double resetDlPRBUsage (); //NS-3 SON: this will be used on pf-ff mac sched
