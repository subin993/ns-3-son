...
double FfMacScheduler::getUlPRBUsage(){
  return m_ulPRBUsage;
}

double FfMacScheduler::getDlPRBUsage(){
  return m_dlPRBUsage;
}

double FfMacScheduler::resetUlPRBUsage(){
  return m_ulPRBUsage =0.0;
}

double FfMacScheduler::resetDlPRBUsage(){
  return m_dlPRBUsage =0.0;
}
