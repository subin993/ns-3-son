...
//try ...
//static double ulPRBUsage = 0.0;
//static double dlPRBUsage = 0.0;
double ulPRBUsage = 0.0;
double dlPRBUsage = 0.0;
...
double
PfFfMacScheduler::getDlPRBUsage(){
  return m_dlPRBUsage;
}

double
PfFfMacScheduler::getUlPRBUsage(){
  return m_ulPRBUsage;
}
...
//try ..
//std::cout << Simulator::Now() << "  rbgSize = " << rbgSize << std::endl;
//std::cout << Simulator::Now() << "  rbgNum = " << rbgNum << std::endl;
//std::cout << Simulator::Now() << "  rbgMap = " << rbgMap << std::endl;
...
//try ..
//if (rbgAllocatedNum > -1)
//{
//std::cout << "rbgAllocatedNum (DL)= " << rbgAllocatedNum << std::endl;
//}
...
//try ..
//std::cout << Simulator::Now() << "  rbAllocated (UL)= " << rbLen << std::endl;
...
//try ...
//	std::cout << Simulator::Now() << "  dlPRBUsage = " << dlPRBUsage << std::endl;
	dlPRBUsage_Now = 1.0 - (static_cast<double>(nrbg_free)/rbgNum);
	// std::cout << "nrbg_free_test :" << nrbg_free << std::endl;
	// std::cout << "rbgNum_test :" << rbgNum << std::endl;
  m_dlPRBUsage = dlPRBUsage_Now;
  // m_dlPRBUsage = 0.99*m_dlPRBUsage + 0.01*dlPRBUsage_Now;
        //dlPRBUsage = 0.99*dlPRBUsage + 0.01*dlPRBUsage_Now;
	// std::cout<< Simulator::Now() << "  dlPRBUsage" << m_dlPRBUsage << std::endl;
  //std::cout << Simulator::Now() << "  dlPRBUsage = " << dlPRBUsage << std::endl;

if (nrbg_free < rbgNum)
	{
//	std::cout << Simulator::Now() << "  nrbg_free = " << nrbg_free << std::endl;
//	std::cout << Simulator::Now() << "  rbgNum = " << rbgNum << std::endl;
	}
...
//try ...
//	std::cout << Simulator::Now() << "  ulPRBUsage = " << ulPRBUsage << std::endl;
	ulPRBUsage_Now = 0.0;
	if (nflows > 0)
		{
		  ulPRBUsage_Now = 1.0;
		}
        ulPRBUsage = 0.99*ulPRBUsage + 0.01*ulPRBUsage_Now;
	// std::cout << Simulator::Now() << "  ulPRBUsage = " << ulPRBUsage << std::endl;
...
//try ..
//std::cout << Simulator::Now() << "  ffrUlBandwidth = " << ffrUlBandwidth << std::endl;
//std::cout << Simulator::Now() << "  nflows = " << nflows << std::endl;
//std::cout << Simulator::Now() << "  rntiAllocated.size = " << rntiAllocated.size () << std::endl;
//std::cout << Simulator::Now() << "  tempRbPerFlow = " << tempRbPerFlow << std::endl;
...
//try ..
//std::cout << "rbAllocated (UL)= " << rbAllocated << std::endl;
//std::cout << "rbgAllocatedNum (DL)= " << rbgAllocatedNum << std::endl;
