...
public: 
  ...
  void ScheduleRrcConnectionRecursive();
...
public:
   ...
   */
  void ConfigureCell (std::map<uint8_t, Ptr<ComponentCarrierBaseStation> > ccPhyConf,int totalEnb);
...
public:
  ...
  ///Calculate the number of UEs attached to eNB
  void CalculateUes ();
